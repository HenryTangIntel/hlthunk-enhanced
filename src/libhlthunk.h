...
#define pr_err(fmt, ...)	    hlthunk_print(HLTHUNK_DEBUG_LEVEL_ERR, fmt, ##__VA_ARGS__)
#define pr_warn(fmt, ...)	    hlthunk_print(HLTHUNK_DEBUG_LEVEL_WARNING, fmt, ##__VA_ARGS__)
#define pr_info(fmt, ...)	    hlthunk_print(HLTHUNK_DEBUG_LEVEL_INFO, fmt, ##__VA_ARGS__)
#define pr_debug(fmt, ...)	    hlthunk_print(HLTHUNK_DEBUG_LEVEL_DEBUG, fmt, ##__VA_ARGS__)
...
#define INIT_FUNCS_POINTERS_TABLE                                                                  \
	{                                                                                          \
		...
		.fp_hlthunk_wait_for_signal_timeout = hlthunk_wait_for_signal_timeout_original,    \
		...
		.fp_hlthunk_request_mapped_command_buffer = hlthunk_request_mapped_command_buffer, \
		...
		.fp_hlthunk_malloc = hlthunk_malloc, .fp_hlthunk_free = hlthunk_free,              \
		.fp_hlthunk_get_time_sync_info = hlthunk_get_time_sync_info,                       \
		.fp_hlthunk_wait_for_collective_sig = hlthunk_wait_for_collective_signal_original, \
		...
		.fp_hlthunk_host_memory_map_flags = hlthunk_host_memory_map_flags_original,        \
		.fp_hlthunk_reserve_signals = hlthunk_reserve_encaps_signals_original,             \
		.fp_hlthunk_unreserve_signals = hlthunk_unreserve_encaps_signals_original,         \
		...
		.fp_get_dram_replaced_rows_info = hlthunk_get_dram_replaced_rows_info_original,    \
		.fp_get_dram_pending_rows_info = hlthunk_get_dram_pending_rows_info_original,      \
		...
		.fp_hlthunk_get_time_sync_per_die_info = hlthunk_get_time_sync_per_die_info,       \
		.fp_hlthunk_get_hw_ip_info = hlthunk_get_hw_ip_info                                \
	}
