 ...
 *                                         operations.
 * @HBLDV_USR_FIFO_TYPE_LAG: mode for lag operations.
 * @HBLDV_USR_FIFO_TYPE_LAG_COMPLETION: mode for lag completion operations.
 */
...
/**
 * enum hbldv_coll_sched_resource_type - scheduler resource type.
