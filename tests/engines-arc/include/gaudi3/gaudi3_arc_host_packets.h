...
#define ARC_AUX_BASE (mmHD0_ARC_FARM_ARC0_AUX_BASE - CFG_BAR_BASE)
/**
 * Firmware interface registers between Scheduler Firmware and Host
 */
#define SCHED_SOB_LBU_ADDR	(ARC_AUX_BASE + mmQMAN_ARC_AUX_SCRATCHPAD_0)
/**<
 * SCAL writes LBU address of the Fence register which it would
 * like Firmware to update
 */
#define SCHED_FW_CONFIG_ADDR	(ARC_AUX_BASE + mmQMAN_ARC_AUX_SCRATCHPAD_1)
/**<
 * SCAL writes ARC address of the Configuration which should be used
 * by firmware for initialization
 */
#define SCHED_FW_CONFIG_SIZE	(ARC_AUX_BASE + mmQMAN_ARC_AUX_SCRATCHPAD_2)
/**<
 * SCAL writes size in bytes of the Configuration which should be used
 * by firmware for initialization
 */
#define SCHED_SOB_LBU_VALUE	(ARC_AUX_BASE + mmQMAN_ARC_AUX_SCRATCHPAD_3)
/**<
 ...
 */
#define ENG_SOB_LBU_ADDR	(ARC_AUX_BASE + mmQMAN_ARC_AUX_SCRATCHPAD_0)
#define ENG_FW_CONFIG_ADDR	(ARC_AUX_BASE + mmQMAN_ARC_AUX_SCRATCHPAD_1)
#define ENG_FW_CONFIG_SIZE	(ARC_AUX_BASE + mmQMAN_ARC_AUX_SCRATCHPAD_2)
#define ENG_SOB_LBU_VALUE	(ARC_AUX_BASE + mmQMAN_ARC_AUX_SCRATCHPAD_3)
